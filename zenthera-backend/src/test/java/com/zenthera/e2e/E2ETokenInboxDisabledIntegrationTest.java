...
@SpringBootTest(properties = "zenthera.e2e.token-inbox.enabled=false")
@AutoConfigureMockMvc
@ActiveProfiles("test")
class E2ETokenInboxDisabledIntegrationTest {
    ...
    @Test
    void doesNotRegisterE2EInfrastructureOutsideTheE2EProfile() {
    ...
    @Test
    void leavesTheE2ERouteDeniedOutsideTheE2EProfile() throws Exception {
